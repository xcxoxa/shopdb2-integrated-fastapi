...
export default function App() {
  ...
  const [branch, setBranch] = useState({ org_id: BRANCH_ORG_ID, org_code: 'OFFIT-SEONGSU', org_name: 'OFFIT 성수점', org_type: 'BRANCH' })
  ...
  return <div className="app-shell">
    ...
    <main><header className="topbar"><div><p className="eyebrow">OFFIT / {branchName} / {page}</p><h1>{page}</h1></div><div className="top-actions"><span className="scope-badge">OFFIT 지사 전용</span><a href={`${API_BASE}/docs`} target="_blank" rel="noreferrer">API 문서</a><div className="avatar">BM</div></div></header>{notice && <div className="toast">{notice}</div>}
